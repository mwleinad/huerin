<div class="grid_16" id="content">
  ...
  <div class="grid_9">
  <h1 class="reportes">Reporte de documentacion permanente</h1>
  </div>
  ...
  <div class="portlet">
       ...
       {include file="forms/search-report-documentacion-permanente.tpl"}       
      ...
      <div class="portlet-content nopadding borderGray" id="contenido">
          {include file="lists/report-documentacion-permanente.tpl"}            
      </div>
      
      <div style="clear:both"></div>
        <br />
      
      {include file="{$DOC_ROOT}/templates/boxes/report-documentacion-status.tpl"}
