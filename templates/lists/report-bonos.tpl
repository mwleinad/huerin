		...
		{foreach from=$item1.CLIENTE item=item2 key=key2}
			{if $item2.OSWA|@count > 0}
				<tr>
					...
					<td align="center" style="{$BORDER_TOP}{$BORDER_LEF}" rowspan="{($item2.OSWA|@count) + (1)}"><big><b>${$item2.TOTAL_MES|number_format:2}</b></big></td>
				</tr>
			{/if}
			...
			{foreach from=$item2.CLIENTE item=item3 key=key3}
				{if $item3.OSWA|@count > 0}
					<tr>
						...
						<td align="center" style="{$BORDER_TOP}{$BORDER_LEF}" rowspan="{($item3.OSWA|@count) + (1)}"><big><b>${$item3.TOTAL_MES|number_format:2}</b></big></td>
					</tr>
				{/if}
				...
				{foreach from=$item3.CLIENTE item=item4 key=key4}
					{if $item4.OSWA|@count > 0}
						<tr>
							...
							<td align="center" style="{$BORDER_TOP}{$BORDER_LEF}" rowspan="{($item4.OSWA|@count) + (1)}"><big><b>${$item4.TOTAL_MES|number_format:2}</b></big></td>
						</tr>
					{/if}
