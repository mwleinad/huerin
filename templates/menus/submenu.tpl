       ...
       <ul>
        	{if $mainMnu == "archivos"}
          	    {foreach from=$resDepartamentos item=item}
                    ...
                    {/if}
               {/foreach}
               {if (in_array(148,$permissions) || $User.isRoot) && ($isSameDepartament || $User.allow_any_departament)}
        ...
        <ul>
        	{if $mainMnu == "catalogos"}
                ...
                {/if}
                {if in_array(288,$permissions)|| $User.isRoot}
            ...
            {if $mainMnu == 'prospect'}
                ...
                {/if}
                {if in_array(287, $permissions) || $User.isRoot}
