                <select size="1" name="{$dayId}" id="{$dayId}" style="height:36px">
	                	<option value="01" {if $day == 1} selected="selected" {/if}>01</option>
                    <option value="02" {if $day == 2} selected="selected" {/if}>02</option>
                    <option value="03" {if $day == 3} selected="selected" {/if}>03</option>
                    <option value="04" {if $day == 4} selected="selected" {/if}>04</option>
                    <option value="05" {if $day == 5} selected="selected" {/if}>05</option>
                    <option value="06" {if $day == 6} selected="selected" {/if}>06</option>
                    <option value="07" {if $day == 7} selected="selected" {/if}>07</option>
                    <option value="08" {if $day == 8} selected="selected" {/if}>08</option>
                    <option value="09" {if $day == 9} selected="selected" {/if}>09</option>
