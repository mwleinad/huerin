<div id="divForm">
	<form id="addProrrogaForm" name="addProrrogaForm" method="post">
		<fieldset>
			<div class="formLine" style="width:100%; text-align:left">
				<div style="width:30%;float:left">* Nueva Fecha de Vencimiento:</div>
                ...
                <tr>
                    ...
                    <div style="float:left; padding-top:5px">
                    	<a href="javascript:void(0)" id="btnAddProrroga">
           ...
           {include file="{$DOC_ROOT}/templates/lists/prorroga.tpl"}
           </div>
           	
            <input type="hidden" id="docGralId" name="docGralId" value="{$docGralId}" />		
			<input type="hidden" id="action" name="action" value="saveAddProrroga"/>
		</fieldset>
	</form>    
</div>
