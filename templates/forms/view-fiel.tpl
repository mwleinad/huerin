...
<thead>
	<tr>
        ...
        <div style="float:left; margin-left:350px">FIEL, CIEC, ISN, IDSE y Sellos Digitales</div>
...
<tbody id="tbFiel">
    <tr>
			...
			<td align="left">{$infoRazonSocial.claveFiel}</td>
		</tr>    

    <tr>
			<td align="left" width="40%">Clave CIEC</td>
			<td align="left">{$infoRazonSocial.claveCiec}</td>
		</tr>    

    <tr>
			<td align="left" width="40%">Clave IDSE</td>
			<td align="left">{$infoRazonSocial.claveIdse}</td>
		</tr>    

    <tr>
			<td align="left" width="40%">Clave Impuesto Sobre Nomina</td>
			<td align="left">{$infoRazonSocial.claveIsn}</td>
		</tr>    
