    ...
    <form id="editCustomerForm" name="editCustomerForm" method="post" autocomplete="off">
        ...
        <fieldset>
            <div class="formLine" style="width:100%; text-align:left">
                ...
                <input class="smallInput medium" name="nameContact" id="nameContact" type="text"
            ...
            <div class="formLine" style="width:100%; text-align:left">
                ...
                <input class="smallInput medium" name="password" id="password" type="text" value="{$post.password}"
                       size="50"/>
                <hr/>
            </div>
            ...
            <div class="formLine" style="width:100%; text-align:left">
                ...
                <textarea class="smallInput medium" name="observacion" id="observacion"
