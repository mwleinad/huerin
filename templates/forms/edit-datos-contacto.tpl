...
<tbody id="tbDatosContacto">
	...
	{if in_array(187,$permissions) || $User.isRoot}
		...
		<tr>
			...
			<td align="left"><input name="emailRepresentanteLegal" id="emailRepresentanteLegal" type="text" value="{$contractInfo.emailRepresentanteLegal}" class="smallInput medium" size="50"/></td>
		</tr>

		<tr>
			<td align="left" width="40%">Telefono representante legal</td>
			<td align="left"><input name="telefonoRepresentanteLegal" id="telefonoRepresentanteLegal" type="text" value="{$contractInfo.telefonoRepresentanteLegal}" class="smallInput medium" size="50"/></td>
		</tr>
	{/if}
