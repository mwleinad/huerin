<div id="divForm">
	<form id="addDocumentForm" name="addDocumentForm" method="post">
		<fieldset>
			...
			* Campos requeridos
            <div class="formLine" style="text-align:center; margin-left:300px">            
                <a class="button_grey" id="btnAddDocument"><span>Agregar</span></a>           
            </div>			
			<input type="hidden" id="type" name="type" value="saveAddDocument"/>
		</fieldset>
	</form>
</div>
