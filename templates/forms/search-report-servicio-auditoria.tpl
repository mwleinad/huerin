...
<tr>	
    <td align="center">
    	...
    	<td align="center">
        	{include file="{$DOC_ROOT}/templates/forms/comp-filter-personal.tpl" class='smallInput'}
		</td>    
		<td align="center">
		   ...
		   <td align="center">
    	<select name="departamentoId" id="departamentoId"  class="smallInput"  style="min-width: 80px">
		...
		<td align="center">    	
    <select name="year" id="year"  class="smallInput" style="min-width: 80px">
	...
	<td>
	    <select name="month" id="month"  class="smallInput"  style="min-width: 80px">
