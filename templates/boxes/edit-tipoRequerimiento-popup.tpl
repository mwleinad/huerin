<div class="popupheader" style="z-index:70">
	...
	<div id="ftitl">
		<div class="flabel">Editar TipoRequerimiento</div>
		<div id="vtitl"><span title="Titulo">Editar TipoRequerimiento</span></div>
	</div>
...
<div class="wrapper">
	{include file="{$DOC_ROOT}/templates/forms/edit-tipoRequerimiento.tpl"}
</div>
