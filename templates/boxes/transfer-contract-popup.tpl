<div class="popupheader" style="z-index:70">
	...
	<div id="ftitl">
		<div class="flabel">Transferencia de contrato entre clientes</div>
		<div id="vtitl"><span title="Titulo">Transferencia de contrato entre clientes</span></div>
	</div>
...
<div class="wrapper" id="det-config">
	{include file="{$DOC_ROOT}/templates/forms/form-transfer-contract.tpl"}
</div>
