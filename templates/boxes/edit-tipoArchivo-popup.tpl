<div class="popupheader" style="z-index:70">
	...
	<div id="ftitl">
		<div class="flabel">Editar TipoArchivo</div>
		<div id="vtitl"><span title="Titulo">Editar TipoArchivo</span></div>
	</div>
...
<div class="wrapper">
	{include file="{$DOC_ROOT}/templates/forms/edit-tipoArchivo.tpl"}
</div>
