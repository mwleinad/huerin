<div class="popupheader" style="z-index:70">
	...
	<div id="ftitl">
		<div class="flabel">Editar TipoServicio</div>
		<div id="vtitl"><span title="Titulo">Editar TipoServicio</span></div>
	</div>
...
<div class="wrapper">
	{include file="{$DOC_ROOT}/templates/forms/edit-tipoServicio.tpl"}
</div>
