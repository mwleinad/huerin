<div class="popupheader" style="z-index:70">
	...
	<div id="ftitl">
		<div class="flabel">Agregar Comentario</div>
		<div id="vtitl"><span title="Titulo">Agregar Comentario</span></div>
	</div>
...
<div class="wrapper">
	{include file="{$DOC_ROOT}/templates/forms/add-comentarioPendiente.tpl"}
</div>
