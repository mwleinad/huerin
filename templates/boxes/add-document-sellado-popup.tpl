<div class="popupheader" style="z-index:70">
	...
	<div id="ftitl">
		<div class="flabel">Agregar Doc. Control Admvo. Int.</div>
		<div id="vtitl"><span title="Titulo">Agregar Doc. Control Admvo. Int.</span></div>
	</div>
...
<div class="wrapper">
	{include file="{$DOC_ROOT}/templates/forms/add-document-sellado.tpl"}
</div>
