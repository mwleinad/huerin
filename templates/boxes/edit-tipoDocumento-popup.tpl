<div class="popupheader" style="z-index:70">
	...
	<div id="ftitl">
		<div class="flabel">Editar TipoDocumento</div>
		<div id="vtitl"><span title="Titulo">Editar TipoDocumento</span></div>
	</div>
...
<div class="wrapper">
	{include file="{$DOC_ROOT}/templates/forms/edit-tipoDocumento.tpl"}
</div>
