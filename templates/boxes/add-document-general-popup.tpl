<div class="popupheader" style="z-index:70">
	...
	<div id="ftitl">
		<div class="flabel">Agregar Documento General</div>
		<div id="vtitl"><span title="Titulo">Agregar Documento General</span></div>
	</div>
...
<div class="wrapper">
	{include file="{$DOC_ROOT}/templates/forms/add-document-general.tpl"}
</div>
