<div class="popupheader" style="z-index:70">
	...
	<div id="ftitl">
		<div class="flabel">Agregar TipoArchivo</div>
		<div id="vtitl"><span title="Titulo">Agregar TipoArchivo</span></div>
	</div>
...
<div class="wrapper">
	{include file="{$DOC_ROOT}/templates/forms/add-tipoArchivo.tpl"}
</div>
