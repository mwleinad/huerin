<div class="popupheader" style="z-index:70">
	...
	<div id="ftitl">
		<div class="flabel">Agregar TipoDocumento</div>
		<div id="vtitl"><span title="Titulo">Agregar TipoDocumento</span></div>
	</div>
...
<div class="wrapper">
	{include file="{$DOC_ROOT}/templates/forms/add-tipoDocumento.tpl"}
</div>
