      ...
      <div id="ftitl">
    		<div class="flabel">Agregar Tipo de Contrato</div>
				<div id="vtitl"><span title="Titulo">Agregar Tipo de Contrato</span></div>
    	</div>
    ...
    <div class="wrapper">
			{include file="{$DOC_ROOT}/templates/forms/add-contract-category.tpl"}
		</div>