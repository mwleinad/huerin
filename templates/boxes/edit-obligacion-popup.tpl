<div class="popupheader" style="z-index:70">
	...
	<div id="ftitl">
		<div class="flabel">Editar Obligacion</div>
		<div id="vtitl"><span title="Titulo">Editar Obligacion</span></div>
	</div>
...
<div class="wrapper">
	{include file="{$DOC_ROOT}/templates/forms/edit-obligacion.tpl"}
</div>
