	...
	<div style="width:500px;  border:solid; border-color:#999;border-width:1px; background-color:#FFF; padding:20px">
       	<div id="close_icon" style="position:absolute;top: 10px; left: 500px;"><img src="{$WEB_ROOT}/images/close_icon.gif" onclick="ToogleStatusDivOnPopup()" style="cursor:pointer"/></div>
