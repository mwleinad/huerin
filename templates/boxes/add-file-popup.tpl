<div class="popupheader" style="z-index:70">
	...
	<div id="ftitl">
		<div class="flabel">Agregar {$post.tipo|ucfirst}</div>
		<div id="vtitl"><span title="Titulo">Agregar {$post.tipo|ucfirst}</span></div>
	</div>
...
<div class="wrapper">
	{include file="{$DOC_ROOT}/templates/forms/add-files.tpl"}
</div>
