<div class="popupheader" style="z-index:70">
	...
	<div id="ftitl">
		<div class="flabel">Agregar Documento</div>
		<div id="vtitl"><span title="Titulo">Agregar Documento</span></div>
	</div>
...
<div class="wrapper">
	{include file="{$DOC_ROOT}/templates/forms/add-documento.tpl"}
</div>
