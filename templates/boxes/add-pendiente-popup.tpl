<div class="popupheader" style="z-index:70">
	...
	<div id="ftitl">
		<div class="flabel">Agregar Pendiente</div>
		<div id="vtitl"><span title="Titulo">Agregar Pendiente</span></div>
	</div>
...
<div class="wrapper">
	{include file="{$DOC_ROOT}/templates/forms/add-pendiente.tpl"}
</div>
