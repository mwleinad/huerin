<div class="popupheader" style="z-index:70">
	...
	<div id="ftitl">
		<div class="flabel">Agregar Documento B&aacute;sico</div>
		<div id="vtitl"><span title="Titulo">Agregar Documento B&aacute;sico</span></div>
	</div>
...
<div class="wrapper">
	{include file="{$DOC_ROOT}/templates/forms/add-document-basic.tpl"}
</div>
