<div class="popupheader" style="z-index:70">
	...
	<div id="ftitl">
		<div class="flabel">Agregar TipoServicio</div>
		<div id="vtitl"><span title="Titulo">Agregar TipoServicio</span></div>
	</div>
...
<div class="wrapper">
	{include file="{$DOC_ROOT}/templates/forms/add-tipoServicio.tpl"}
</div>
