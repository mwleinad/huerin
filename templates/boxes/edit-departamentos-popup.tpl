<div class="popupheader" style="z-index:70">
	...
	<div id="ftitl">
		<div class="flabel">Editar Departamento</div>
		<div id="vtitl"><span title="Titulo">Editar Departamento</span></div>
	</div>
...
<div class="wrapper">
	{include file="{$DOC_ROOT}/templates/forms/edit-departamentos.tpl"}
</div>
