<div class="popupheader" style="z-index:70">
    ...
    <div id="ftitl">
        <div class="flabel">Editar Servicio</div>
        <div id="vtitl"><span title="Titulo">Editar Comentario</span></div>
    </div>
...
<div class="wrapper">
    {include file="{$DOC_ROOT}/templates/forms/edit-comentario-contract.tpl"}
</div>
