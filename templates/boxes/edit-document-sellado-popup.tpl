<div class="popupheader" style="z-index:70">
	...
	<div id="ftitl">
		<div class="flabel">Editar Doc. Control Admvo. Int.</div>
		<div id="vtitl"><span title="Titulo">Editar Doc. Control Admvo. Int.</span></div>
	</div>
...
<div class="wrapper">
	{include file="{$DOC_ROOT}/templates/forms/edit-document-sellado.tpl"}
</div>
