      ...
      <div id="ftitl">
    		<div class="flabel">Agregar Subcategoria</div>
				<div id="vtitl"><span title="Titulo">Agregar Subcategoria</span></div>
    	</div>
    ...
    <div class="wrapper">
			{include file="{$DOC_ROOT}/templates/forms/add-contract-subcategory.tpl"}
		</div>