<div class="popupheader" style="z-index:70">
	...
	<div id="ftitl">
		<div class="flabel">Agregar TipoRequerimiento</div>
		<div id="vtitl"><span title="Titulo">Agregar TipoRequerimiento</span></div>
	</div>
...
<div class="wrapper">
	{include file="{$DOC_ROOT}/templates/forms/add-tipoRequerimiento.tpl"}
</div>
