<div class="popupheader" style="z-index:70">
	...
	<div id="ftitl">
		<div class="flabel">{$data.tittle}</div>
		<div id="vtitl"><span title="Titulo">{$data.tittle}</span></div>
	</div>
...
<div class="wrapper">
	{include file="{$DOC_ROOT}/templates/forms/form-change-status-pending.tpl"}
</div>
