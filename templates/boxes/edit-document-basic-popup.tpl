<div class="popupheader" style="z-index:70">
	...
	<div id="ftitl">
		<div class="flabel">Editar Documento B&aacute;sico</div>
		<div id="vtitl"><span title="Titulo">Editar Documento B&aacute;sico</span></div>
	</div>
...
<div class="wrapper">
	{include file="{$DOC_ROOT}/templates/forms/edit-document-basic.tpl"}
</div>
