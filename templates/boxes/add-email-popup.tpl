<div class="popupheader" style="z-index:70">
	...
	<div id="ftitl">
		<div class="flabel">Enviar Reporte por Correo</div>
		<div id="vtitl"><span title="Titulo">Enviar Reporte por Correo</span></div>
	</div>
...
<div class="wrapper">
	{include file="{$DOC_ROOT}/templates/forms/add-email.tpl"}
</div>
