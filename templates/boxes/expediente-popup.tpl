<div class="popupheader" style="z-index:70">
	...
	<div id="ftitl">
		<div class="flabel">{if $info}Editar expediente{else}Agregar expediente{/if}</div>
		<div id="vtitl"><span title="Titulo">{if $info}Editar expediente{else}Agregar expediente{/if}</span></div>
	</div>
...
<div class="wrapper">
	{include file="{$DOC_ROOT}/templates/forms/form-expediente.tpl"}
</div>
