      ...
      <div id="ftitl">
    		<div class="flabel">Editar Subcategoria</div>
				<div id="vtitl"><span title="Titulo">Editar Subcategoria</span></div>
    	</div>
    ...
    <div class="wrapper">
			{include file="{$DOC_ROOT}/templates/forms/edit-contract-subcategory.tpl"}
		</div>