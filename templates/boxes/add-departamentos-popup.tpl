<div class="popupheader" style="z-index:70">
	...
	<div id="ftitl">
		<div class="flabel">Agregar Departamento</div>
		<div id="vtitl"><span title="Titulo">Agregar Departamento</span></div>
	</div>
...
<div class="wrapper">
	{include file="{$DOC_ROOT}/templates/forms/add-departamentos.tpl"}
</div>
