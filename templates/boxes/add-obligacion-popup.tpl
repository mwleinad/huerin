<div class="popupheader" style="z-index:70">
	...
	<div id="ftitl">
		<div class="flabel">Agregar Obligacion</div>
		<div id="vtitl"><span title="Titulo">Agregar Obligacion</span></div>
	</div>
...
<div class="wrapper">
	{include file="{$DOC_ROOT}/templates/forms/add-obligacion.tpl"}
</div>
