      ...
      <div id="ftitl">
    		<div class="flabel">Editar Tipo de Contrato</div>
				<div id="vtitl"><span title="Titulo">Editar Tipo de Contrato</span></div>
    	</div>
    ...
    <div class="wrapper">
			{include file="{$DOC_ROOT}/templates/forms/edit-contract-category.tpl"}
		</div>