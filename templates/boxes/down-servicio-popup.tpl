<div class="popupheader" style="z-index:70">
	...
	<div id="ftitl">
		<div class="flabel">Baja de servicio</div>
		<div id="vtitl"><span title="Titulo">Baja de servicio</span></div>
	</div>
...
<div class="wrapper" id="det-config">
	{include file="{$DOC_ROOT}/templates/forms/form-down-servicio.tpl"}
</div>
