<div class="popupheader" style="z-index:70">
    ...
    <div id="ftitl">
        <div class="flabel">Verificar status de factura en el SAT</div>
        <div id="vtitl"><span title="Titulo">Verificar status en el SAT</span></div>
    </div>
...
<div class="wrapper">
    {include file="{$DOC_ROOT}/templates/forms/frm-check-status-invoice.tpl"}
</div>
