<div class="popupheader" style="z-index:70">
	...
	<div id="ftitl">
		<div class="flabel">Editar DocumentoGeneral</div>
		<div id="vtitl"><span title="Titulo">Editar Documento General</span></div>
	</div>
...
<div class="wrapper">
	{include file="{$DOC_ROOT}/templates/forms/edit-document-general.tpl"}
</div>
