...
<body>
    ...
    <table cellpadding="0" cellspacing="0" class="tableFullWidth">
        <thead>
        <tr>
            <th colspan="6" class="titleCenter">Nuevos servicios agregados</th>
        </tr>
        <tr>
            <th>Servicio</th>
        ...
        {foreachelse}
            <tr>
                <td colspan="6" class="textCenter">No se realizo ninguna modificacion</td>
            </tr>
        {/foreach}
        </tbody>
    </table>
    ...
    <table cellpadding="0" cellspacing="0" class="tableFullWidth">
        <thead>
        <tr>
            <th colspan="6" class="titleCenter">Servicios existentes</th>
        </tr>
        <tr>
            <th>Servicio</th>
            <th>Inicio operacion</th>
        ...
        <tbody>
        {foreach from=$actuales key=key item=item}
            <tr>
                <td>{$item.nombreServicio}</td>
                <td>{$item.inicioOperaciones}</td>
                <td>{$item.inicioFactura}</td>
