<div class="grid_16" id="content">
    ...
    <div class="grid_9">
        <h1 class="catalogos">Expedientes</h1>
    </div>
    ...
    <div class="grid_6" id="eventbox">
        ...
        {/if}
        {if in_array(183,$permissions) ||$User.isRoot}
            <a href="javascript:void(0)" class="inline_add" id="addExpediente">Agregar Expediente</a>
        {/if}
        <div id="loadPrint">
        </div>
    </div>
    ...
    <div id="portlets">
        ...
        <div class="portlet">
            ...
            <div class="portlet-content nopadding borderGray" id="contenido">
                ...
                {include file="lists/expediente.tpl"}
