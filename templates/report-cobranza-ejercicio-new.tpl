<div class="grid_16" id="content">
	...
	<div id="portlets">
		...
		<div class="portlet">
			...
			{*include file="forms/search-report-cobranza-ejercicio-new.tpl"*}
{include file="forms/search-report-documentacion-permanente.tpl"}    
			<br />
			{include file="{$DOC_ROOT}/templates/boxes/report-walmart-status-new.tpl"}
			...
			<div class="portlet-content nopadding borderGray" id="contenido">
				...
				{include file="lists/report-cobranza-ejercicio-new.tpl"}
			</div>
