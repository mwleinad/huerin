<table width="100%" cellpadding="0" cellspacing="0" id="box-table-a">
    <thead>
      <tr>
        <th style="width: 5%;" scope="col">Serie</th>
        <th style="width: 5%;" scope="col">Folio</th>
        ...
        <th style="width: 5%;" scope="col">Version CFDI</th>
        <th style="width: 5%;" scope="col">Nombre PDF</th>
      </tr>
    </thead>
