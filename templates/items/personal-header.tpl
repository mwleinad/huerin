<thead>
	<tr>
		...
		{if in_array(239,$permissions)|| $User.isRoot}<th width="150">Contraseña computadora</th>{/if}
		{if in_array(241,$permissions)|| $User.isRoot}<th width="150">Usuario plataforma</th>{/if}
		{if in_array(242,$permissions)|| $User.isRoot}<th width="150">Contrase&ntilde;a plataforma</th>{/if}
