<div class="grid_16" id="content">
  ...
  <div class="grid_9">
  <h1 class="reportes">Reporte de archivos permanentes</h1>
  </div>
<div class="grid_6" id="eventbox">
  ...
  <div class="portlet">
       ...
       {include file="forms/search-report-archivos-permanente.tpl"}       
      ...
      <div class="portlet-content nopadding borderGray" id="contenido">
          {include file="lists/report-archivos-permanente.tpl"}            
      </div>
      
      <div style="clear:both"></div>
        <br />
      
      {include file="{$DOC_ROOT}/templates/boxes/report-archivos-status.tpl"}
