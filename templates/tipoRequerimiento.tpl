<div class="grid_16" id="content">
  ...
  <div class="grid_9">
  <h1 class="catalogos">Tipos de Requerimiento</h1>
  </div>
  ...
  <div class="grid_6" id="eventbox">
      ...
      <a href="javascript:void(0)" class="inline_add" id="addTipoRequerimiento">Agregar Requerimiento</a>
  <div id="loadPrint">
  </div>
  </div>
  ...
  <div class="portlet">
	...
	{include file="lists/tipoRequerimiento.tpl"}
