<div class="grid_16" id="content">
  ...
  <div class="grid_9">
  <h1 class="content_edit">Historial de Documentaci&oacute;n  Contrato No. {$info.contractId}</h1>
  </div>
  ...
  <div class="portlet">
        ...
        <tr>
            ...
            {if $item.B.name != ""}
            <div class="boxEnt st{$item.B.status} txtSt{$item.B.status}" id="rounded-box2">
                <b>Documento:</b>
                <br />
                {$item.B.name}
                <br /><br />
            ...
            <td align="center">
            {if $item.O.name != ""}           
             <div class="boxEnt st{$item.O.status} txtSt{$item.O.status}" id="rounded-box2">
             	<b>Documento:</b>
                <br>
                {$item.O.name}          
                <br /><br />                
            ...
            <td align="center">
             ...
             {if $item.S.name != ""}           
             <div class="boxEnt st{$item.S.status} txtSt{$item.S.status}" id="rounded-box2">
                <b>Documento:</b>
                <br />
                {$item.S.name}
                <br /><br />               
       ...
       <a href="javascript:void(0)" onclick="history.back(-1)">Regresar</a>
       </div>
