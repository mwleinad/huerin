<?php
// SE MODIFICO, SE COLOCO EXIT POR LA TAREA:
// #17340: [MOD] Hacer los sigueintes cambios en los reportes semanales que se mandan los lunes (reporteSemanal, reporteSemanalContador, etc)
// AVISALE A JONY PARA QE TE EXPLIQUE
exit();
