...
else
{
	...
	foreach($employees as $employee)
	{
		...
		foreach($servicios as $servicio2)
		{
      $message .= "Servicio:<b>".$servicio2["nombreServicio"]."</b><br>";
      $message .= "Nombre del Cliente:<b>".$servicio2["clienteName"]."</b><br>";
      $message .= "Nombre de la Razon Social:<b>".$servicio2["razonSocialName"]."</b><br>";

			foreach($servicio2["instancias"] as $instanciaServicio)
			{
