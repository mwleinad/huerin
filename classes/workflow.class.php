        ...
        foreach ($clientes as $keyCliente => $cliente) {
            ...
            foreach ($clientes[$keyCliente]["contracts"] as $keyContract => $contract) {
                ...
                switch ($contract["class"]) {
                    case "PorIniciar":
                        $_SESSION["PorIniciarContract"]++;
                        break;
                    case "PorCompletar":
                        $_SESSION["PorCompletarContract"]++;
                        break;
                    case "Iniciado":
                        $_SESSION["IniciadoContract"]++;
                        break;
                    case "Completo":
                        $_SESSION["CompletoContract"]++;
                        break;
                    case "CompletoTardio":
                        $_SESSION["CompletoTardioContract"]++;
                        break;
                }
                ...
                foreach ($contract["instanciaServicio"] as $instancia) {
                    switch ($instancia["class"]) {
                        case "PorIniciar":
                            $_SESSION["PorIniciarServicio"]++;
                            break;
                        case "PorCompletar":
                            $_SESSION["PorCompletarServicio"]++;
                            break;
                        case "Iniciado":
                            $_SESSION["IniciadoServicio"]++;
                            break;
                        case "Completo":
                            $_SESSION["CompletoServicio"]++;
                            break;
                        case "CompletoTardio":
                            $_SESSION["CompletoTardioServicio"]++;
                            break;
                    }
                    ...
                    foreach ($instancia["steps"] as $step) {
                        switch ($step["class"]) {
                            case "PorIniciar":
                                $_SESSION["PorIniciarSteps"]++;
                                break;
                            case "PorCompletar":
                                $_SESSION["PorCompletarSteps"]++;
                                break;
                            case "Iniciado":
                                $_SESSION["IniciadoSteps"]++;
                                break;
                            case "Completo":
                                $_SESSION["CompletoSteps"]++;
                                break;
                            case "CompletoTardio":
                                $_SESSION["CompletoTardioSteps"]++;
                                break;
                        }
                    }
                }
