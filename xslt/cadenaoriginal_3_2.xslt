...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:cfdi="http://www.sat.gob.mx/cfd/3" xmlns:ecc="http://www.sat.gob.mx/ecc" xmlns:psgecfd="http://www.sat.gob.mx/psgecfd" xmlns:donat="http://www.sat.gob.mx/donat" xmlns:divisas="http://www.sat.gob.mx/divisas" xmlns:detallista="http://www.sat.gob.mx/detallista" xmlns:ecb="http://www.sat.gob.mx/ecb" xmlns:implocal="http://www.sat.gob.mx/implocal" xmlns:terceros="http://www.sat.gob.mx/terceros" xmlns:iedu="http://www.sat.gob.mx/iedu" xmlns:ventavehiculos="http://www.sat.gob.mx/ventavehiculos" xmlns:pfic="http://www.sat.gob.mx/pfic" xmlns:tpe="http://www.sat.gob.mx/TuristaPasajeroExtranjero" xmlns:leyendasFisc="http://www.sat.gob.mx/leyendasFiscales" xmlns:spei="http://www.sat.gob.mx/spei" xmlns:nomina="http://www.sat.gob.mx/nomina" xmlns:registrofiscal="http://www.sat.gob.mx/registrofiscal" xmlns:pagoenespecie="http://www.sat.gob.mx/pagoenespecie" xmlns:consumodecombustibles="http://www.sat.gob.mx/consumodecombustibles" xmlns:valesdedespensa="http://www.sat.gob.mx/valesdedespensa" xmlns:aerolineas="http://www.sat.gob.mx/aerolineas" xmlns:notariospublicos="http://www.sat.gob.mx/notariospublicos" xmlns:vehiculousado="http://www.sat.gob.mx/vehiculousado" xmlns:servicioparcial="http://www.sat.gob.mx/servicioparcialconstruccion" xmlns:destruccion="http://www.sat.gob.mx/certificadodestruccion" xmlns:decreto="http://www.sat.gob.mx/renovacionysustitucionvehiculos" xmlns:obrasarte="http://www.sat.gob.mx/arteantiguedades" xmlns:aieps="http://www.sat.gob.mx/acreditamiento" xmlns:ecc11="http://www.sat.gob.mx/EstadoDeCuentaCombustible" xmlns:cce="http://www.sat.gob.mx/ComercioExterior" xmlns:ine="http://www.sat.gob.mx/ine" xmlns:nomina12="http://www.sat.gob.mx/nomina12" xmlns:cce11="http://www.sat.gob.mx/ComercioExterior11">
  ...
  <!--
	...
	-->
  <xsl:include href="http://comprobantedigital.mx/sistema/xslt/utilerias.xslt"/>
  <!-- 
		En esta sección se define la inclusión de las demás plantillas de transformación para 
		la generación de las cadenas originales de los complementos fiscales 
	-->
  <xsl:include href="http://comprobantedigital.mx/sistema/xslt/ecc.xslt"/>
  <xsl:include href="http://comprobantedigital.mx/sistema/xslt/psgecfd.xslt"/>
  <xsl:include href="http://comprobantedigital.mx/sistema/xslt/donat11.xslt"/>
  <xsl:include href="http://comprobantedigital.mx/sistema/xslt/divisas.xslt"/>
  <xsl:include href="http://comprobantedigital.mx/sistema/xslt/ecb.xslt"/>
  <xsl:include href="http://comprobantedigital.mx/sistema/xslt/detallista.xslt"/>
  <xsl:include href="http://comprobantedigital.mx/sistema/xslt/implocal.xslt"/>
  <xsl:include href="http://comprobantedigital.mx/sistema/xslt/terceros11.xslt"/>
  <xsl:include href="http://comprobantedigital.mx/sistema/xslt/iedu.xslt"/>
  <xsl:include href="http://comprobantedigital.mx/sistema/xslt/ventavehiculos11.xslt"/>
  <xsl:include href="http://comprobantedigital.mx/sistema/xslt/pfic.xslt"/>
  <xsl:include href="http://comprobantedigital.mx/sistema/xslt/TuristaPasajeroExtranjero.xslt"/>
  <xsl:include href="http://comprobantedigital.mx/sistema/xslt/leyendasFisc.xslt"/>
  <xsl:include href="http://comprobantedigital.mx/sistema/xslt/spei.xslt"/>
  <xsl:include href="http://comprobantedigital.mx/sistema/xslt/nomina11.xslt"/>
  <xsl:include href="http://comprobantedigital.mx/sistema/xslt/cfdiregistrofiscal.xslt"/>
  <xsl:include href="http://comprobantedigital.mx/sistema/xslt/pagoenespecie.xslt"/>
  <xsl:include href="http://comprobantedigital.mx/sistema/xslt/consumodecombustibles.xslt"/>
  <xsl:include href="http://comprobantedigital.mx/sistema/xslt/valesdedespensa.xslt"/>
  <xsl:include href="http://comprobantedigital.mx/sistema/xslt/aerolineas.xslt"/>
  <xsl:include href="http://comprobantedigital.mx/sistema/xslt/notariospublicos.xslt"/>
  <xsl:include href="http://comprobantedigital.mx/sistema/xslt/vehiculousado.xslt"/>
  <xsl:include href="http://comprobantedigital.mx/sistema/xslt/servicioparcialconstruccion.xslt"/>
  <xsl:include href="http://comprobantedigital.mx/sistema/xslt/certificadodedestruccion.xslt"/>
  <xsl:include href="http://comprobantedigital.mx/sistema/xslt/renovacionysustitucionvehiculos.xslt"/>
  <xsl:include href="http://comprobantedigital.mx/sistema/xslt/obrasarteantiguedades.xslt"/>
  <xsl:include href="http://comprobantedigital.mx/sistema/xslt/AcreditamientoIEPS10.xslt"/>
  <xsl:include href="http://comprobantedigital.mx/sistema/xslt/ecc11.xslt"/>
  <xsl:include href="http://comprobantedigital.mx/sistema/xslt/ComercioExterior10.xslt"/>
  <xsl:include href="http://comprobantedigital.mx/sistema/xslt/ine10.xslt"/>
  <xsl:include href="http://comprobantedigital.mx/sistema/xslt/ine11.xslt"/>
  <xsl:include href="http://comprobantedigital.mx/sistema/xslt/nomina12.xslt"/>
  <xsl:include href="http://comprobantedigital.mx/sistema/xslt/ComercioExterior11.xslt"/>
