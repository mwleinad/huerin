...
function GoToWorkflow(path, id)
{
	...
	{
  	parameters: {value: id, type: "goToWorkflow", path: path, rfc: $('rfc').value, responsableCuenta: responsableCuenta, status: $('status').value, month: $('month').value, year: $('year').value, from: "report-obligaciones"},
		method:'post',
