...
function GoToWorkflow(path, id, rfc, year)
{
	...
	{
  	parameters: {value: id, type: "goToWorkflow", path: path, rfc: rfc, responsableCuenta: 0, year: year, from: "report-servicios"},
		method:'post',
    onSuccess: function(transport){
      var response = transport.responseText || "no response text";
			window.open(WEB_ROOT+"/workflow-cliente/id/"+id, '_blank');
			//window.location = 
		},
