...
if($_SESSION["CompletoSteps"] + $_SESSION["CompletoTardioSteps"] + $_SESSION["PorCompletarSteps"] + $_SESSION["IniciadoSteps"] + $_SESSION["PorIniciarSteps"] == 0)
{
	$_SESSION["CompletoSteps"] = 1;
}

$data = array($_SESSION["CompletoSteps"],$_SESSION["CompletoTardioSteps"],$_SESSION["PorCompletarSteps"],$_SESSION["IniciadoSteps"],$_SESSION["PorIniciarSteps"]);
...
$graph->title->Set("Grafica de Pasos");
...
$fileName = DOC_ROOT."/imagefile_steps.png";
